			...
			<div id="info-confirm">
				...
				<div id="cart">
					...
					<table cellspacing="0" id="cart_table">
						...
						<tfoot>
							<tr>
								<th class="thumbnail"></th>
								<th colspan="3" class="aright">
									<?php esc_html_e( 'total items', 'usces' ); ?>
								</th>
								<th colspan="2" class="aright amount">
									<?php usces_crform( $usces_entries['order']['total_items_price'], true, false ); ?>
								</th>
							</tr>
							...
							<tr>
								...
								<td colspan="3" class="aright">
									<?php echo wp_kses_post( apply_filters( 'usces_confirm_discount_label', __( 'Campaign disnount', 'usces' ) ) ); ?>
								</td>
								<td colspan="2" class="aright" style="color:#FF0000">
								<?php usces_crform( $usces_entries['order']['discount'], true, false ); ?></td>
							</tr>
							<?php endif; ?>
							...
							<tr>
								<td class="thumbnail"></td>
								<td colspan="3" class="aright">
									<?php echo wp_kses_post( apply_filters( 'usces_filter_cod_label', __( 'COD fee', 'usces' ) ) ); ?>
								</td>
					...
					<form action="<?php usces_url( 'cart' ); ?>" method="post" onKeyDown="if(event.keyCode === 13){return false;}">
						...
						<table cellspacing="0" id="point_table">
							<tr>
								...
								<td>
									<span class="point">
										<?php echo wp_kses_post( $usces_members['point'] ); ?>
									</span>pt
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="offer[usedpoint]" class="used_point" type="text" value="<?php esc_attr( $usces_entries['order']['usedpoint'] ); ?>" />pt
								</td>
							</tr>
							<tr>
								<td colspan="2" class="point-btn">
									<input name="use_point" type="submit" class="use_point_button" value="<?php esc_attr_e( 'Use the points', 'usces' ); ?>" />
								</td>
							</tr>
						</table>
				...
				<table id="confirm_table">
					<tr class="ttl">
						<td colspan="2">
							<h3>
								<?php esc_html_e( 'Customer Information', 'usces' ); ?>
							</h3>
						</td>
					</tr>
					<tr>
						...
						<td>
							<?php echo esc_html( $usces_entries['customer']['mailaddress1'] ); ?>
						</td>
					</tr>
					...
					<?php if ( wel_have_shipped() ) : ?>
						<tr>
							...
							<td>
								<?php echo esc_html( usces_delivery_method_name( $usces_entries['order']['delivery_method'], 'return' ) ); ?>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<?php echo esc_html( $usces_entries['order']['delivery_date'] ); ?>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<?php echo esc_html( $usces_entries['order']['delivery_time'] ); ?>
							</td>
						</tr>
					<?php endif; ?>
					<tr>
						...
						<td>
							<?php echo esc_html( $usces_entries['order']['payment_name'] . usces_payment_detail( $usces_entries ) ); ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<?php echo nl2br( esc_html( $usces_entries['order']['note'] ) ); ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<?php echo esc_html( $usces_entries['order']['terms'] ? __( 'Agree', 'welcart_simpleplus' ) : '' ); ?>
						</td>
					</tr>
					<?php endif; ?>
				</table>
