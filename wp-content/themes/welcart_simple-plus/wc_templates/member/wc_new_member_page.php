		...
		<article class="post" id="wc_<?php usces_page_name(); ?>">
			...
			<div id="memberpages">
				<div id="newmember">
					...
					<form action="<?php echo esc_url_raw( apply_filters( 'usces_filter_newmember_form_action', usces_url( 'member', 'return' ) ) ); ?>" method="post" onKeyDown="if(event.keyCode == 13){return false;}">
						<table border="0" cellpadding="0" cellspacing="0" class="customer_form">
							...
							<tr>
								...
								<td colspan="2"><input name="member[password1]" id="password1" type="password" value="<?php usces_memberinfo( 'password1' ); ?>" autocomplete="new-password" /><?php wel_password_policy_message(); ?></td>
							</tr>
							<tr>
