...
<div id="primary" class="site-content">
	...
	if ( have_posts() ) :
		...
		<article class="post" id="wc_autodelivery_history">

			<h1 class="member_page_title"><?php esc_html_e( 'Regular purchase information', 'autodelivery' ); ?></h1>
				...
				<div class="whitebox">
					<div id="memberinfo">
						...
						<form action="<?php usces_url( 'member' ); ?>#autodelivery" method="post" onKeyDown="if(event.keyCode == 13){return false;}">
							...
							<div class="send">
								<input class="back-mypage" name="back" type="button" value="<?php esc_attr_e( 'Back to the member page.', 'autodelivery' ); ?>" onclick="location.href='<?php echo esc_url_raw( USCES_MEMBER_URL ); ?>'" />
								<input class="back-top" name="top" type="button" value="<?php esc_attr_e( 'Back to the top page.', 'usces' ); ?>" onclick="location.href='<?php echo esc_url_raw( home_url() ); ?>'" />
							</div>
