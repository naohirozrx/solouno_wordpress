...
<div id="privacy-area">
  <section class="privacy-top">
    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/privacy-title-bg.jpg" />
    <div>
      <h2>プライバシーポリシー</h2>
  ...
  <section class="privacy-contents">
    <p>ソロウーノ（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。</p>
    <dl>
      <dt>第1条（個人情報）</dt>
    ...
    <dl>
      ...
      <dd>
        ...
        <br />
        住所：〒330-0854 埼玉県さいたま市大宮区桜木町1-9-1 三谷ビル1階<br />
        社名：ソロウーノ<br />
        担当者：相川　亜希乃<br />
        E-mail：shop@solouno-ordermade.com<br />
        <br />
