    ...
    <?php if(have_posts()): ?>
      ...
      <dl class="<?php echo get_field('cancel') ? 'cancel' : ''; ?>">
        ...
        <dd>
          ...
          <?php endif; ?>
          <div><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/reserve-icon.svg" />予約：<?php echo get_field('reserve') ? '必要' : '不要'; ?></div>
          <div><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/spot-icon.svg" />開催エリア：<?php echo get_field('area');?></div>
