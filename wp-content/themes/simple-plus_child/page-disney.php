...
<div id="flow-area">
  ...
  <section class="schoolbag-area">
    <nav>
      <ul style="line-height: 1.3;">
        <li style="margin-bottom: 0.5em;">〇<a href="#step" style="text-decoration: underline;">シミュレーター</a></li>
        <li style="margin-bottom: 0.5em;">〇<a href="#spec" style="text-decoration: underline;">選べるポイントStep1〜5</a></li>
        <li style="margin-bottom: 0.5em;">〇<a href="#gallery" style="text-decoration: underline;">デザイン紹介</a></li>
        <li style="margin-bottom: 0.5em;">〇<a href="#howtoorder" style="text-decoration: underline;">HOW TO ORDER</a></li>
        <li style="margin-bottom: 0.5em;">〇<a href="#function" style="text-decoration: underline;">ディズニーオーダーの便利機能</a></li>
  ...
  <section class="disney-flow">
    <a href="https://disneysim.solouno-ordermade.com/" class="">オーダーを選んでみよう！<br />【シミューレーター】</a>
