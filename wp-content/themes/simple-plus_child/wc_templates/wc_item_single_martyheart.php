...
<script>
	$(function() {
		...
		$('.item-option > dd:nth-child(2) > select option[value="<?php echo $heartTypeA; ?>"]').prop('selected', true);
		$('.item-option > dd:nth-child(4) > select option[value="<?php echo $heartTypeA; ?>"]').prop('selected', true);
		$('.item-option > dd:nth-child(6) > select option[value="<?php echo $heartTypeC; ?>"]').prop('selected', true);
		$('.item-option > dd:nth-child(8) > select option[value="<?php echo $heartTypeA; ?>"]').prop('selected', true);
		$('.item-option > dd:nth-child(10) > select option[value="<?php echo $heartTypeE; ?>"]').prop('selected', true);
		$('.item-option > dd:nth-child(12) > select option[value="<?php echo $heartTypeF; ?>"]').prop('selected', true);
