					...
					<div class="detail-box">
						...
						<table class="dlseller">
							<tr>
								...
								<td><?php esc_html( usces_dlseller_validity( $post ) ); ?></td>
							</tr>
							<tr>
								<th><?php esc_html_e( 'File Name', 'dlseller' ); ?></th>
								<td><?php esc_html( usces_dlseller_filename( $post ) ); ?></td>
							</tr>
							<tr>
								<th><?php esc_html_e( 'Release Date', 'dlseller' ); ?></th>
								<td><?php esc_html( usces_get_itemMeta( '_dlseller_date', $post->ID, 'return' ) ); ?></td>
							</tr>
							<tr>
								<th><?php esc_html_e( 'Version', 'dlseller' ); ?></th>
								<td><?php esc_html( usces_get_itemMeta( '_dlseller_version', $post->ID, 'return' ) ); ?></td>
							</tr>
							<tr>
								<th><?php esc_html_e( 'Author', 'dlseller' ); ?></th>
								<td><?php esc_html( usces_get_itemMeta( '_dlseller_author', $post->ID, 'return' ) ); ?></td>
							</tr>
						</table>
