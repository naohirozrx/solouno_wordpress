  ...
  <section class="exhibit-single-area">
    <dl class="<?php echo get_field('cancel') ? 'cancel' : ''; ?>">
      ...
      <dd>
        ...
        <?php endif; ?>
        <div class="info-area"><img src="<?php echo get_template_directory_uri(); ?>/images/reserve-icon.svg" />予約：<?php echo get_field('reserve') ? '必要' : '不要'; ?></div>
        <div class="info-area"><img src="<?php echo get_template_directory_uri(); ?>/images/spot-icon.svg" />開催エリア：<?php echo get_field('area');?></div>
