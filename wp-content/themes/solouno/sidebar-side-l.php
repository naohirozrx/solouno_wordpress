  ...
  <div class="bg-area">
    <div class="menu-area">
      ...
      <h1>
        ...
        <lottie-player src="https://lottie.host/0e0894f6-8b7b-44e5-9f95-3f2ef8491532/vMfUYNWIIp.json"  background="transparent"  speed="1"  style="width: 100%; height: 100%;"  autoplay></lottie-player>
      </h1>
      <ul>
        <li><a href="<?php echo home_url('/')?>">HOME</a></li>
        <li><a href="<?php echo home_url('/')?>aboutus">SOLO UNOについて</a></li>
        <li><a href="#">オーダーランドセル</a></li>
        <li><a href="#">展示会情報</a></li>
        <li><a href="<?php echo home_url('/')?>column">コラム</a></li>
        <li><a href="<?php echo home_url('/')?>news">お知らせ</a></li>
        <li><a href="#">店舗限定商品</a></li>
        <li><a href="#">店舗案内</a></li>
        <li><a href="#">資料請求</a></li>
      </ul>
    </div>
