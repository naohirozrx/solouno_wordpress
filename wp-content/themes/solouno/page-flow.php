...
<div id="flow-area">
  ...
  <section class="spec-area">
    <h2 id="spec"><img src="<?php echo get_template_directory_uri(); ?>/images/dot-mini2.svg" />ORDER PRICE & SPEC<img src="<?php echo get_template_directory_uri(); ?>/images/dot-mini2.svg" /></h2>
    <h3>クラリーノ エフ 64,800円</h3>
    <ul class="price-list">
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-1black.png" />
          <figcaption>ブラック</figcaption>
        </figure>
      </li>
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-2navy.png" />
          <figcaption>ネイビー</figcaption>
        </figure>
      </li>
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-3blue.png" />
          <figcaption>ブルー</figcaption>
        </figure>
      </li>
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-4olive.png" />
          <figcaption>オリーブ</figcaption>
        </figure>
      </li>
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-5vividpink.png" />
          <figcaption>ビビッド<br />ピンク</figcaption>
        </figure>
      </li>
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-9mistyrose.png" />
          <figcaption>ミスティ<br />ローズ</figcaption>
        </figure>
      </li>
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-10marshmallowpink.png" />
          <figcaption>マシュマロ<br />ピンク</figcaption>
        </figure>
      </li>
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-11iris.png" />
          <figcaption>アイリス</figcaption>
        </figure>
      </li>
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-12marshmallowblue.png" />
          <figcaption>マシュマロ<br />ブルー</figcaption>
        </figure>
      </li>
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-13mintgreen.png" />
          <figcaption>ミント<br />グリーン</figcaption>
        </figure>
      </li>
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-14ivory.png" />
          <figcaption>アイボリー</figcaption>
        </figure>
      </li>
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-15cinnamon.png" />
          <figcaption>シナモン</figcaption>
        </figure>
      </li>
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-16greige.png" />
    ...
    <ul class="price-list2">
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-6tnblack.png" />
          <figcaption>タフネオブラック</figcaption>
        </figure>
      </li>
      <li>
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/order-7tnnavy.png" />
    ...
    <ul class="price-list3">
      <li>
        <h4>アラベスク / クローバー</h4>
        <img src="<?php echo get_template_directory_uri(); ?>/images/priceside-1.jpg" />
        <p>上記の金額に<br />＋3,000円</p>
      </li>
      <li>
        <h4>レース</h4>
        <img src="<?php echo get_template_directory_uri(); ?>/images/priceside-2.jpg" />
...
<path d="M8.49769 19.9832L20.4294 11.1914C20.7776 10.9362 21.2233 10.9362 21.5715 11.1914L33.5032 19.9832C33.8143 20.2151 34 20.6141 34 21.0549V28.7332C34 29.2435 33.7447 29.7028 33.35 29.8977C33.0193 30.0661 32.6496 30.0228 32.3519 29.7956L20.9773 21.1801L9.6398 29.5358C8.8821 30.0989 7.96631 29.3569 8.00095 28.4641C8.00092 28.4641 8.00092 21.0549 8.00092 21.0549C8.00092 20.6141 8.18663 20.2151 8.49769 19.9832Z" fill="#AC7746"/>
  ...
  <h2 id="howtoorder"><img src="<?php echo get_template_directory_uri(); ?>/images/dot-mini2.svg" />HOW TO ORDER<img src="<?php echo get_template_directory_uri(); ?>/images/dot-mini2.svg" /></h2>
    <div>
      <!--<dl>
        <dt>
  ...
  <section class="convenience-area">
    <h2 id="function"><img src="<?php echo get_template_directory_uri(); ?>/images/dot-mini2.svg" />SOLO UNOの便利機能<img src="<?php echo get_template_directory_uri(); ?>/images/dot-mini2.svg" /></h2>
