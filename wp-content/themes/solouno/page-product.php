...
<div id="product-area">
  ...
  <section class="ordermade-area">
    ...
    <a href="https://sim.solouno-ordermade.com/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/ordermade.jpg" class="om-p1" /></a>
    ...
    <a href="https://sim.solouno-ordermade.com" target="_blank" class="om-link">オーダーメイドを選んでみよう<br />【シミュレーター】</a>
