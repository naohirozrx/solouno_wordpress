...
<div id="product-area">
  ...
  <section class="marty-area">
    <h2><span>MARTY</span>マーティ</h2>
    <img src="<?php echo get_template_directory_uri(); ?>/images/dot.svg" class="dot" />
    <img src="<?php echo get_template_directory_uri(); ?>/images/disney-p1.jpg" class="marty-p1" />
    <p>テキストがこちらに入ります。テキストがこちらに入ります。<br />テキストがこちらに入ります。テキストがこちらに入ります。テキストがこちらに入ります。</p>
    <a href="#">商品を見る</a>
  </section>
  <section class="totebag-area">
    <h2><span>TOTE BAG</span>トートバッグ</h2>
    <img src="<?php echo get_template_directory_uri(); ?>/images/dot.svg" class="dot" />
    <img src="<?php echo get_template_directory_uri(); ?>/images/disney-p1.jpg" class="totebag-p1" />
    <p>テキストがこちらに入ります。テキストがこちらに入ります。<br />テキストがこちらに入ります。テキストがこちらに入ります。テキストがこちらに入ります。</p>
    <a href="#">商品を見る</a>
  </section>
</div>
