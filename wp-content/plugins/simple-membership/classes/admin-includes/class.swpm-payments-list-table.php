...
class SWPMPaymentsListTable extends WP_List_Table {
	...
	function column_id( $item ) {
		...
		$actions = array(
			...
			'delete' => sprintf( '<a href="admin.php?page=simple_wp_membership_payments&action=delete_txn&id=%s" onclick="return confirm(\''.SwpmUtils::_('Are you sure you want to delete this record?').'\')">'.__("Delete").'</a>', $item['id'] ), // kayama change
		);
