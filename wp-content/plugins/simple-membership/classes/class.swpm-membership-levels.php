...
class SwpmMembershipLevels extends WP_List_Table {
    ...
    function column_id($item) {
        ...
        $actions = array(
            'edit' => sprintf('<a href="admin.php?page=simple_wp_membership_levels&level_action=edit&id=%s">'.__('Edit').'</a>', $item['id']),
            'delete' => sprintf('<a href="admin.php?page=simple_wp_membership_levels&level_action=delete&id=%s&delete_swpmlevel_nonce=%s" onclick="return confirm(\''.SwpmUtils::_('Are you sure you want to delete this entry?').'\')">'.SwpmUtils::_('Delete').'</a>', $item['id'],$delete_swpmlevel_nonce),
        );
