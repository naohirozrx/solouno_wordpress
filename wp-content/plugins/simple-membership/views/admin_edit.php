...
<div class="wrap" id="swpm-profile-page" type="edit">
    ...
    <table class="form-table">
        ...
        <!-- 改変 -->
        <tr class="form-required swpm-admin-edit-email" style="display:none;">
        ...
        <!-- 改変 -->
        <tr class="swpm-admin-edit-password" style="display:none;">
	...
	<!-- 改変 -->
	<tr class="swpm-admin-edit-notify-user" style="display:none;">
    ...
    <tr class="swpm-admin-edit-subscriber-id">
		...
		<th scope="row"><label for="member_expiry_date">有効期限</label></th>
		<td>
                    <?php 
