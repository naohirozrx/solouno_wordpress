	...
	<div class="postbox">
		...
		<div class="inside">
			<form action="" method="post">
				<label>
				    <input type="radio" name="button_type" value="pp_buy_now" checked> 
				    <?php echo( '【 PayPal 】今すぐ購入' ); ?>
				</label>
				<br>
				<label>
				    <input type="radio" name="button_type" value="pp_subscription"> 
				    <?php echo( '【 PayPal 】サブスクリプション' ); ?>
				</label>
				
				<!-- 
				<br />
				<label>
				    <input type="radio" name="button_type" value="pp_smart_checkout"> 
				    <?php SwpmUtils::e( 'PayPal Smart Checkout' ); ?>
				</label>
				-->

				<br />
				<label><input type="radio" name="button_type" value="stripe_buy_now"> <?php SwpmUtils::e( '【 Stripe 】今すぐ購入' ); ?></label>
				<br />
				<label><input type="radio" name="button_type" value="stripe_subscription"> <?php SwpmUtils::e( '【 Stripe 】サブスクリプション' ); ?></label>
				<br />
