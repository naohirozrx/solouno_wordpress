            ...
            <div class="inside">
                <table class="form-table" width="100%" border="0" cellspacing="0" cellpadding="6">
					...
					<tr valign="top">
                        ...
                        <td>
                            <input type="text" size="50" name="button_text" value="<?php echo ($edit ? $opts['button_text'] : ''); ?>" required />
                ...
                <table class="form-table" width="100%" border="0" cellspacing="0" cellpadding="6">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <p class="description">プラグインでサブスクリプションの有効期限を自動的に処理する場合は、Stripeアカウントに新しいWebhookを作成し、このURLをそこに配置する必要があります。
                            </p>
                        </td>
                    </tr>
                ...
                <table class="form-table" width="100%" border="0" cellspacing="0" cellpadding="6">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <p class="description">ボタンを画像で装飾する場合はここに画像のURLを入力します。</p>
                        </td>
                    </tr> 
...
function swpm_save_edit_stripe_subscription_button_data() {
    ...
    if (isset($edit)) {
		...
		update_post_meta($button_id, 'button_text', trim(sanitize_text_field($_REQUEST['button_text'])));
