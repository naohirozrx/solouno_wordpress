		...
		$fields = array(
			...
			*/
			...
			'time_delay' => array(
				...
				'description'=> '次のメッセージが送れる様になるまでの時間(分) 0=すぐに送信可能',
			),
			'editor_type' => array(
				'type'		=> 'select',
				'value'		=> fep_get_option( 'editor_type', 'textarea' ),
				'priority'	=> 12,
			...
			'show_directory' => array(
				...
				'class'		 => '',
				'label'		 => 'ユーザー検索',
				'cb_label'	 => 'ユーザーの一覧を表示させる',
				'description'=> '登録されているユーザー全員を表示させます',
			),
			/*
			'show_branding'	=> array(
				'type'		=> 'checkbox',
			...
			*/
			...
			'from_name' => array(
				...
				'description'=> 'DM受診時に送信されるすべての電子メールは、この名前が送信者名として設定されます。',
			),
			'from_email' => array(
				'type'		 => 'email',
				...
				'description'=> 'DM機能プラグインから送信されるすべての電子メールは、この電子メールアドレスが送信者メールアドレスとして設定されます。'
			),
			'notify_ann' => array(
				'type'		=> 'checkbox',
			...
			*/
			'reply_deleted_mgs' => array(
				...
				'cb_label'	=> '他のユーザーが削除したメッセージに返信できますか?',
			),
