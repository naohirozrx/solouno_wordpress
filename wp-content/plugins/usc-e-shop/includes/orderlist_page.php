...
<div class="usces_tablenav usces_tablenav_top">
	<?php echo $dataTableNavigation; // phpcs:ignore ?>
...
<div class="usces_tablenav usces_tablenav_bottom" ><?php echo $dataTableNavigation; // phpcs:ignore ?></div>
...
?>
				html += '<option value="<?php echo esc_attr($k_pm); ?>"<?php echo $rselected ?>><?php echo esc_html($v_pm['alias']); ?></option>';
<?php
	endforeach;
?>
